...
public class MyFail {
    ...
    public MyFail(Context context, String msgFail, String msgDesc) {
        (dialog = new Dialog(context, android.R.style.Theme_Holo_Light_NoActionBar)).setContentView(io.github.alfinosuroso.R.layout.activity_payment_fail);
        this.tvFail = (TextView) this.dialog.findViewById(io.github.alfinosuroso.R.id.tv_fail);
